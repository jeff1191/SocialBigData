...
object Instructions {
  ...
  val CREATE_ENRICHMENT_AIR ="CREATE_ENRICHMENT_AIR"
  val CREATE_ENRICHMENT_TRAFFIC ="CREATE_ENRICHMENT_TRAFFIC"
  val CREATE_ENRICHMENT_AIR_TRAFFIC ="CREATE_ENRICHMENT_AIR_TRAFFIC"
